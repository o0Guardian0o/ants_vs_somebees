...
public class ButtonLvl3 extends JButton implements MouseListener {

	private String name;
	private Image img;

	public ButtonLvl3(String str) {
		super(str);
		this.name = str;
		try {
	...
	public void mouseClicked(MouseEvent event) {
		...
		AntColony colony = new AntColony(4, 7, 3, level.getFood());																									// food]
		Hive hive = Hive.makeInsaneHive();
		new AntGame(colony, hive, gamepoint, 3);
		level.defLevel();
	}
}
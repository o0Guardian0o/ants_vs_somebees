...
public class Place {
	...
	private ArrayList<Bee> dead_bees; // a list of the current dead bees
	 ...
	 * (read the content of the "println" to understand this method
	 * @param ant
	...
	/**
	 * Overload of the preceding method to solve a game_point problem 
	 * @param bee The bee to remove from the place.
	 * @param a A useless parameter to make the overload
	 */

...
public class Hive extends Place {
	 ...
	 * @return A filled hive
	 */
	public static Hive makeEasyHive () {
	...
	/**
	 * Makes a hive filled with a moderate number of attacking bees
	 * 
	 * @return A filled hive, moderate hive
	 */
	public static Hive makeNormalHive () {
		Hive hive = new Hive(3);
		hive.addWave(2, 1);

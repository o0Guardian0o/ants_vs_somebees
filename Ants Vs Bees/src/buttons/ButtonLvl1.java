...
public class ButtonLvl1 extends JButton implements MouseListener {

	private String name;
	private Image img;

	public ButtonLvl1(String str) {
		super(str);
		this.name = str;
		try {
	...
	public void mouseClicked(MouseEvent event) {
		...
		AntColony colony = new AntColony(3, 6, 3, level.getFood());																									// food]
		Hive hive = Hive.makeTestHive();
		new AntGame(colony, hive, gamepoint,1);
		level.defLevel();
	}
}